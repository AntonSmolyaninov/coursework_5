...
class Habit(models.Model):
    ...
    periodicity = models.IntegerField(choices=Periodicity.choices, default=Periodicity.DAILY,
                                      validators=[validate_periodicity])
    reward = models.CharField(max_length=255, blank=True, null=True, verbose_name='Вознаграждение')
    execution_time = models.PositiveIntegerField(validators=[validate_execution_time], verbose_name='Время выполнения (сек)')
